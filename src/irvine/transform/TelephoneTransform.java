...
/**
 * Report the telephone encoding of each word. Any symbols not having
 * a corresponding code a converted to spaces.
 * @author Sean A. Irvine
 */
public class TelephoneTransform implements Transform {
